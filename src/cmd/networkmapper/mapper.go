...
func init() {
	...
	MapperCmd.PersistentFlags().StringSlice(mapperclient.MapperExcludeLabels, []string{}, `a list of labels that if appear on pods, should be excluded from list/export. example: "include=false"`)
